...
Element renderTuiConfigurationLayout(
    ...
    leftElements.push_back(renderCenteredInputRow("目的地 X:", inputX));
    leftElements.push_back(separatorEmpty());
    ...
    leftElements.push_back(separatorEmpty());
    leftElements.push_back(renderCenteredInputRow("红色 TNT:", inputRedTnt));
    leftElements.push_back(separatorEmpty());
    leftElements.push_back(renderCenteredInputRow("蓝色 TNT:", inputBlueTnt));
    leftElements.push_back(separatorEmpty());
    leftElements.push_back(renderCenteredInputRow("方向:", inputDirection));
